            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url('');?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="200px;" src="<?php echo base_url().'theme/images/merdeka1.png'?>"></a>
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome to Min 1 Probolinggo</h2>
               <p>Selamat Datang di Website, 
                Kami Menyambut baik terbitnya Website ini dengan harapan 
                semoga dengan adanya media ini dapat memberikan informasi dan layanan pendidikan kepada siswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Probolinggo Jawa Timur</p>
                        <p>Email : smk@gmail.com
                            <br> Phone : +62</p>
